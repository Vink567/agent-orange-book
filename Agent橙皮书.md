...
- [第一篇：先搞懂 Agent 是什么](#第一篇先搞懂-agent-是什么)
  - [为什么现在要懂 Agent？](#为什么现在要懂-agent)
  - [Agent 的基础认知](#agent-的基础认知)
  - [Agent 和 ChatGPT 有什么区别？](#agent-和-chatgpt-有什么区别)
  - [Agent 的核心组成](#agent-的核心组成)
- [第二篇：Agent 相关概念](#第二篇agent-相关概念)
  - [Agent、Workflow、Automation 的区别](#agentworkflowautomation-的区别)
  - [Agent、Skill、MCP 的关系](#agentskillmcp-的关系)
  - [Agent 和 AI 编程工具的关系](#agent-和-ai-编程工具的关系)
  - [Agent 和 GitHub 的关系](#agent-和-github-的关系)
- [第三篇：Agent 如何使用](#第三篇agent-如何使用)
  - [如何正确指挥 Agent](#如何正确指挥-agent)
  - [Agent 标准工作流](#agent-标准工作流)
  - [Agent Prompt 模板库](#agent-prompt-模板库)
  - [Agent 使用中的常见错误](#agent-使用中的常见错误)
- [第四篇：Agent 实战案例](#第四篇agent-实战案例)
  - [资料整理 Agent](#资料整理-agent)
  - [自动复盘 Agent](#自动复盘-agent)
- [第五篇：Agent 风险与进阶](#第五篇agent-风险与进阶)
  - [Agent 的风险与防护](#agent-的风险与防护)
  - [如何验收 Agent 的结果](#如何验收-agent-的结果)
  - [如何把好用流程沉淀成 Skill](#如何把好用流程沉淀成-skill)
  - [普通人的 Agent 学习路线图](#普通人的-agent-学习路线图)
  - [第五篇总结](#第五篇总结)
- [附录](#附录)
